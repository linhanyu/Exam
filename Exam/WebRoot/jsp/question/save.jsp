...
<div class="data_list">
	...
	<div class="data_content">
		<form action="question_save?page=${page}" method="post" onsubmit="return checkForm()">
		<table width="90%" align="center">
			<tr>
				<td><label>题目名称：</label></td>
				<td>
					<input type="text" id="subject" name="subject" value="${question.subject }"  class="input-xxlarge"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input type="text" id="joinTime" class="Wdate" onClick="WdatePicker()" name="joinTime" value="<fmt:formatDate value="${question.joinTime }" type="date" pattern="yyyy-MM-dd"/>" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input type="text" id="answer" name="answer" value="${question.answer }" />&nbsp;&nbsp;(多选题答案用#隔开，如"A#D")
				</td>
			</tr>
			<tr>
				<td>
					<input type="hidden" id="questionId" name="id" value="${question.id }"/><button class="btn btn-primary" type="submit">保存</button>
				</td>
				<td>
